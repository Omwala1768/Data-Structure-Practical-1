...
def stack_operations():
    ...
    while True:
        ...
        if choice == 1:
            ...
            try:
                position = int(input(colored("Enter the position to insert at (0-basedindex): ", "green")))
            ...
            try:
                position = int(input(colored("Enter the position to delete from (0based index): ", "green")))
