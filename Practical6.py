...
def main():
    while True:
        try :
            max_capacity = int(input("Enter maximum capacity of your Priority Queue : "))
            break
        except ValueError :
            print(Fore.RED + "Please Enter a Valid Number !" + Style.RESET_ALL)

    pq = omwala_priorityqueue(max_capacity)
    while True:
        print(Fore.YELLOW + "\n~~~ Om Wala Priority Queue Menu ~~~" + Style.RESET_ALL)
        ...
        print(Fore.YELLOW + "8. Exit Program" + Style.RESET_ALL)

        try :
            om_choice = int(input(Fore.BLUE + "Enter your Choice : " + Style.RESET_ALL))
        except ValueError :
